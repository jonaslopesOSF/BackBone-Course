...
var VenueView = Backbone.View.extend({
	...
	onClick: function(){
		this.bus.trigger("venueSelected", this.model); // trigger the event
	},
...
var MapView = Backbone.View.extend({
	...
	initialize: function(options){
		this.bus = options.bus; //handler
		this.bus.on("venueSelected", this.onVenueSelected, this); // subscribe
	},
...
var bus = _.extend({}, Backbone.Events); // event
